...
class LessonCRUDTestCase(APITestCase):
    def setUp(self):
        ...
        self.lesson_detail_url = reverse('materials:lessons_retrieve', kwargs={'pk': self.lesson1.pk})
        self.lesson_create_url = reverse('materials:lessons_create')
        self.lesson_update_url = reverse('materials:lessons_update', kwargs={'pk': self.lesson1.pk})
        self.lesson_delete_url = reverse('materials:lessons_delete', kwargs={'pk': self.lesson1.pk})
    ...
    def test_update_lesson_owner(self):
        ...
        self.assertEqual(self.lesson1.name, 'Updated Lesson Name')

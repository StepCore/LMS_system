    ...
    def handle(self, *args, **options):
        try:
            ...
            user1, _ = User.objects.get_or_create(
                ...
                defaults={"phone": "+79991112233", "city": "Москва"},
            )

            user2, _ = User.objects.get_or_create(
                email="user2@example.com",
                defaults={"phone": "+79994445566", "city": "Санкт-Петербург"},
            )

            # Создаем тестовые курсы и уроки, если их нет
            course1, _ = Course.objects.get_or_create(
                name="Python Basics", defaults={"description": "Базовый курс по Python"}
            )

            course2, _ = Course.objects.get_or_create(
                name="Django Pro",
                defaults={"description": "Продвинутый курс по Django"},
            )

            lesson1, _ = Lesson.objects.get_or_create(
                name="Введение в Python",
                defaults={"course": course1, "description": "Основы языка Python"},
            )
